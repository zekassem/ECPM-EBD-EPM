...
def logic_cuts(c,w_v,edges,x_v,no_edges,z_v): # function that adds the logic cuts
...
for num in no_dist:
    ...
    with open('Results/computation_time_1st_Logic_2nd_Compact_no_dist_'+str(num)+'_tol_'+str(t)+'_prob_'+str(prob)+'.csv','w') as newFile:
        ...
        Model_W_Cuts=Model_W_Cuts(edges,z_v)
