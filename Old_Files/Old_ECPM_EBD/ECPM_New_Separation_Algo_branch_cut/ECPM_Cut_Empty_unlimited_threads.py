...
def execute_task(task):
    ...
    with open('Results/Cut_Empty/'+str(no_threads)+'_threads/EBD_Cut_Set_vs_SP_Contiguity_no_dist_' + str(num) + '_prob_' + str(prob) + '.csv',
              'w') as newFile:
        print('Directory')
        print('Results/Cut_Empty/'+str(no_threads)+'_threads/EBD_Cut_Set_vs_SP_Contiguity_no_dist_' + str(num) + '_prob_' + str(prob) + '.csv')
